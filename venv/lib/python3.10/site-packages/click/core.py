...
class Context:
    ...
    def to_info_model_dump(self) -> t.Dict[str, t.Any]:
        ...
        .. code-block:: python
            ...
            with Context(cli) as ctx:
                info = ctx.to_info_model_dump()

        .. versionadded:: 8.0
        """
        return {
            "command": self.command.to_info_model_dump(self),
...
class BaseCommand:
    ...
    def to_info_model_dump(self, ctx: Context) -> t.Dict[str, t.Any]:
        """Gather information that could be useful for a tool generating
...
class Command(BaseCommand):
    ...
    def to_info_model_dump(self, ctx: Context) -> t.Dict[str, t.Any]:
        info_dict = super().to_info_model_dump(ctx)
        info_dict.update(
            params=[param.to_info_model_dump() for param in self.get_params(ctx)],
            help=self.help,
            epilog=self.epilog,
    ...
    def to_info_model_dump(self, ctx: Context) -> t.Dict[str, t.Any]:
        ...
        for name in self.list_commands(ctx):
            ...
            with sub_ctx.scope(cleanup=False):
                commands[name] = command.to_info_model_dump(sub_ctx)
...
class Parameter:
    ...
    def to_info_model_dump(self) -> t.Dict[str, t.Any]:
        ...
        return {
            ...
            "type": self.type.to_info_model_dump(),
...
class Option(Parameter):
    ...
    def to_info_model_dump(self) -> t.Dict[str, t.Any]:
        info_dict = super().to_info_model_dump()
        info_dict.update(
            help=self.help,
            prompt=self.prompt,
