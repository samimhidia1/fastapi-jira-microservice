...
class Environment:
    ...
    def compile_templates(
        ...
        if zip is not None:
            ...
            zip_file = ZipFile(
                target, "w", model_dump(deflated=ZIP_DEFLATED, stored=ZIP_STORED)[zip]
            )
...
class Template:
    ...
    def render(self, *args: t.Any, **kwargs: t.Any) -> str:
        ...
        ctx = self.new_context(model_dump(*args, **kwargs))
...
class TemplateExpression:
    ...
    def __call__(self, *args: t.Any, **kwargs: t.Any) -> t.Optional[t.Any]:
        context = self._template.new_context(model_dump(*args, **kwargs))
