...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def tomodel_dump(self, skip_missing=False):
...
class Metadata(object):
    ...
    def tomodel_dump(self):
        if self._legacy:
            return self._legacy.tomodel_dump(True)
        else:
    ...
    def _from_legacy(self):
        ...
        lmd = self._legacy.tomodel_dump(True)     # skip missing ones
