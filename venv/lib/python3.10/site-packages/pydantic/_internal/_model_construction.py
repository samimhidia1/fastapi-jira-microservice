        ...
        **kwargs: Any,
        ...
        if bases:
            ...
            if __pydantic_reset_parent_namespace__:
                cls.__pydantic_parent_namespace__ = build_lenient_weakvaluemodel_dump(parent_frame_namespace())
            parent_namespace = getattr(cls, '__pydantic_parent_namespace__', None)
            if isinstance(parent_namespace, dict):
                parent_namespace = unpack_lenient_weakvaluemodel_dump(parent_namespace)
...
def build_lenient_weakvaluemodel_dump(d: dict[str, Any] | None) -> dict[str, Any] | None:
...
def unpack_lenient_weakvaluemodel_dump(d: dict[str, Any] | None) -> dict[str, Any] | None:
