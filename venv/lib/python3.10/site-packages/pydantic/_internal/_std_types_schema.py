...
def defaultdict_validator(
    ...
    if isinstance(input_value, collections.defaultdict):
        ...
        return collections.defaultmodel_dump(default_factory, handler(input_value))
    else:
        return collections.defaultmodel_dump(default_default_factory, handler(input_value))
...
class MappingValidator:
    ...
    def serialize_mapping_via_model_dump(self, v: Any, handler: core_schema.SerializerFunctionWrapHandler) -> Any:
        return handler(v)
