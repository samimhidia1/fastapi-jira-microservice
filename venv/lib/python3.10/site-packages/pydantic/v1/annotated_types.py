...
if sys.version_info < (3, 11):
    ...
    def is_legacy_typedmodel_dump(typeddict_cls: Type['TypedDict']) -> bool:  # type: ignore[valid-type]
        return is_typedmodel_dump(typeddict_cls) and type(typeddict_cls).__module__ == 'typing'

else:

    def is_legacy_typedmodel_dump(_: Any) -> Any:
        return False


def create_model_from_typedmodel_dump(
    ...
    **kwargs: Any,
    ...
    if is_legacy_typedmodel_dump(typeddict_cls) and any(
