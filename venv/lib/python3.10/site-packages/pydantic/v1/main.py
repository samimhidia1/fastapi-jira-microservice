...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def __setattr__(self, name, value):  # noqa: C901 (ignore complexity)
        ...
        if self.__config__.extra is not Extra.allow and name not in self.__fields__:
            ...
            if known_field:
                ...
                # - keep other values (e.g. submodels) untouched (using `BaseModel.model_dump()` will change them into dicts)
    ...
    def json(
        ...
        **dumps_kwargs: Any,
        ...
        """
        Generate a JSON representation of the model, `include` and `exclude` arguments as per `model_dump()`.
    ...
    def validate(cls: Type['Model'], value: Any) -> 'Model':
        ...
        if isinstance(value, dict):
            ...
            try:
                value_as_dict = model_dump(value)
            except (TypeError, ValueError) as e:
    ...
    def _decompose_class(cls: Type['Model'], obj: Any) -> GetterDict:
        if isinstance(obj, GetterDict):
            return obj
        return cls.__config__.getter_model_dump(obj)
