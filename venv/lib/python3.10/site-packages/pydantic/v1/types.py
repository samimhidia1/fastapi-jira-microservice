...
def conint(
    *,
    ...
    namespace = model_dump(strict=strict, gt=gt, ge=ge, lt=lt, le=le, multiple_of=multiple_of)
...
def confloat(
    *,
    ...
    # use kwargs then define conf in a dict to aid with IDE type hinting
    namespace = model_dump(strict=strict, gt=gt, ge=ge, lt=lt, le=le, multiple_of=multiple_of, allow_inf_nan=allow_inf_nan)
...
def condate(
    *,
    ...
    # use kwargs then define conf in a dict to aid with IDE type hinting
    namespace = model_dump(gt=gt, ge=ge, lt=lt, le=le)
