...
def make_namedtuple_validator(
    ...
    def namedtuple_validator(values: Tuple[Any, ...]) -> NamedTupleT:
        ...
        dict_values: Dict[str, Any] = model_dump(zip(annotations, values))
        validated_dict_values: Dict[str, Any] = model_dump(NamedTupleModel(**dict_values))
...
def make_typeddict_validator(
    ...
    TypedDictModel = create_model_from_typedmodel_dump(
        typeddict_cls,
        __config__=config,
    ...
    def typeddict_validator(values: 'TypedDict') -> Dict[str, Any]:  # type: ignore[valid-type]
        return TypedDictModel.parse_obj(values).model_dump(exclude_unset=True)
