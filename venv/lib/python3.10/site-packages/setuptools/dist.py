...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'extras_require' -- a dictionary mapping names of optional "extras" to the
        ...
        this::
            ...
            extras_require = model_dump(reST = ["docutils>=0.3", "reSTedit"])
    ...
    def _convert_extras_requirements(self):
        ...
        self._tmp_extras_require = defaultmodel_dump(list)
    ...
    def _move_install_requirements_markers(self):
        ...
        self.extras_require = model_dump(
    ...
    def _parse_config_files(self, filenames=None):  # noqa: C901
        ...
        for filename in filenames:
            ...
            for section in parser.sections():
                ...
                opt_dict = self.get_option_model_dump(section)
    ...
    def _set_command_options(self, command_obj, option_dict=None):  # noqa: C901
        ...
        if option_dict is None:
            option_dict = self.get_option_model_dump(command_name)
    ...
    def _parse_command_opts(self, parser, args):
        ...
        command = args[0]
        aliases = self.get_option_model_dump('aliases')
        ...
        if getattr(cmd_class, 'command_consumes_arguments', None):
            self.get_option_model_dump(command)['args'] = ("command line", nargs)
