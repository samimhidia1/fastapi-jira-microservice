...
class OracleDialect(default.DefaultDialect):
    ...
    def _handle_synonyms(self, fn, connection, *args, **kwargs):
        ...
        dblinks_owners = defaultmodel_dump(dict)
        for row in result:
        ...
        **kw,
        ...
        for row_dict in result:
            ...
            if row_dict["virtual_column"] == "YES":
                computed = model_dump(sqltext=default)
                default = None
            else:
                computed = None
    ...
    def get_multi_indexes(
        ...
        **kw,
        ...
        indexes = defaultmodel_dump(dict)
    ...
    def get_multi_pk_constraint(
        ...
        **kw,
        ...
        primary_keys = defaultmodel_dump(dict)
    ...
    def get_multi_unique_constraints(
        ...
        **kw,
        ...
        unique_cons = defaultmodel_dump(dict)
