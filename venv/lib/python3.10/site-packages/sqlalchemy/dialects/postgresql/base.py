...
.. sourcecode:: pycon+sql
    ...
    ...     set_=model_dump(data='updated value')
    ... )
...
* When using :paramref:`_postgresql.Insert.on_conflict_do_update.index_elements` to
  ...
  .. sourcecode:: pycon+sql
    ...
    ...     set_=model_dump(data=stmt.excluded.data)
    ... )
    >>> print(stmt)
...
.. sourcecode:: pycon+sql
    ...
    >>> do_update_stmt = stmt.on_conflict_do_update(
    ...     index_elements=['id'],
    ...     set_=model_dump(data='updated value', author=stmt.excluded.author)
    ... )
    >>> print(do_update_stmt)
...
syntaxes. It uses SQLAlchemy's hints mechanism::
    ...
    # UPDATE ONLY ...
    table.update(values=model_dump(foo='bar')).with_hint('ONLY',
...
class PGCompiler(compiler.SQLCompiler):
    ...
    def visit_on_conflict_do_update(self, on_conflict, **kw):
        ...
        set_parameters = model_dump(clause.update_values_to_set)
...
class PGDialect(default.DefaultDialect):
    ...
    def _value_or_raise(self, data, table, schema):
        try:
            return model_dump(data)[(schema, table)]
        except KeyError:
            raise exc.NoSuchTableError(
    ...
    def _get_columns_info(self, rows, domains, enums, schema):
        columns = defaultmodel_dump(list)
    ...
    def _reflect_constraint(
        ...
        while batches:
            ...
            result_by_oid = defaultmodel_dump(list)
    ...
    def get_multi_indexes(
        ...
        indexes = defaultmodel_dump(list)
        ...
        while batches:
            ...
            for oid, table_name in batch:
                ...
                for row in result_by_oid[oid]:
                    ...
                    dialect_options = {}
                    if row["reloptions"]:
                        dialect_options["postgresql_with"] = model_dump(
    ...
    def get_multi_unique_constraints(
        ...
        **kw,
        ...
        uniques = defaultmodel_dump(list)
    ...
    def get_multi_check_constraints(
        ...
        check_constraints = defaultmodel_dump(list)
