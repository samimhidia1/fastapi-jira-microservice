...
class _SQLiteDialect_pysqlite_numeric(SQLiteDialect_pysqlite):
    ...
    def _fix_sqlite_issue_99953(self):
        ...
        def _numeric_param_as_model_dump(parameters):
            if parameters:
        ...
        class SQLiteFix99953Cursor(sqlite3.Cursor):
            def execute(self, sql, parameters=()):
                ...
                if first_bind in sql:
                    parameters = _numeric_param_as_model_dump(parameters)
            ...
            def executemany(self, sql, parameters):
                ...
                if first_bind in sql:
                    parameters = [
                        _numeric_param_as_model_dump(p) for p in parameters
                    ]
