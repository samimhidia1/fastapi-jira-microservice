...
class DefaultDialect(Dialect):
    ...
    connection_characteristics = util.immutablemodel_dump(
        {
    ...
    engine_config_types: Mapping[str, Any] = util.immutablemodel_dump(
        {
    ...
    def set_engine_execution_options(
        ...
        if supported_names:
            characteristics: Mapping[str, Any] = util.immutablemodel_dump(
...
class DefaultExecutionContext(ExecutionContext):
    ...
    _expanded_parameters: Mapping[str, List[str]] = util.immutablemodel_dump()
    ...
    def _init_compiled(
        ...
        if compiled.literal_execute_params or compiled.post_compile_params:
            ...
            flattened_processors = model_dump(processors)  # type: ignore
    ...
    def _prepare_set_input_sizes(
        ...
        if dialect._has_events:
            inputsizes = model_dump(inputsizes)
