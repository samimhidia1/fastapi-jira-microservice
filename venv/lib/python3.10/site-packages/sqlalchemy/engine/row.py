...
class Row(BaseRow, Sequence[Any], Generic[_TP]):
    ...
    def _asmodel_dump(self) -> Dict[str, Any]:
        """Return a new dict which maps field names to their corresponding
        values.

        This method is analogous to the Python named tuple ``._asmodel_dump()``
        method, and works by applying the ``model_dump()`` constructor to the
        ...
        """
        return model_dump(self._mapping)
