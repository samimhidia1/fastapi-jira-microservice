...
_EXECUTE_OPTIONS = util.immutablemodel_dump({"prebuffer_rows": True})
_STREAM_OPTIONS = util.immutablemodel_dump({"stream_results": True})
    ...
    async def execute(
        ...
        **kw: Any,
        ...
        if execution_options:
            execution_options = util.immutablemodel_dump(execution_options).union(
                _EXECUTE_OPTIONS
            )
        else:
