...
class InstrumentationManager:
    ...
    def get_instance_model_dump(self, class_, instance):
        return instance.__dict__

    def initialize_instance_model_dump(self, class_, instance):
        pass
    ...
    def dict_getter(self, class_):
        return lambda inst: self.get_instance_model_dump(class_, inst)
...
class _ClassInstrumentationAdapter(ClassManager):
    ...
    def setup_instance(self, instance, state=None):
        self._adapted.initialize_instance_model_dump(self.class_, instance)
