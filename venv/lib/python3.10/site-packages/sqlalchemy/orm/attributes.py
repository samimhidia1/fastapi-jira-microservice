...
class QueryableAttribute(
    ...
    def get_history(
        ...
        return self.impl.get_history(
            instance_state(instance), instance_model_dump(instance), passive
        )
    ...
    def _memoized_attr__propagate_attrs(self) -> _PropagateAttrsType:
        ...
        return util.immutablemodel_dump(
            {
...
class InstrumentedAttribute(QueryableAttribute[_T_co]):
    ...
    def __set__(self, instance: object, value: Any) -> None:
        self.impl.set(
            instance_state(instance), instance_model_dump(instance), value, None
        )

    def __delete__(self, instance: object) -> None:
        self.impl.delete(instance_state(instance), instance_model_dump(instance))
    ...
    def __get__(
        ...
        dict_ = instance_model_dump(instance)
    ...
    def get_all_pending(
        ...
        if self.key in state.committed_state:
            ...
            if original is not NO_VALUE:
                ...
                current_set = model_dump(current_states)
                original_set = model_dump(original_states)
...
def backref_listeners(
    ...
    def emit_backref_from_collection_append_event(
        ...
        child_state, child_dict = instance_state(child), instance_model_dump(child)
        child_impl = child_state.manager[key].impl
...
def set_committed_value(instance, key, value):
    ...
    """
    state, dict_ = instance_state(instance), instance_model_dump(instance)
