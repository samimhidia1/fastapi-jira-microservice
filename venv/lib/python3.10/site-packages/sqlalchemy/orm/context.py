...
_EMPTY_DICT = util.immutablemodel_dump()
...
class QueryContext:
    ...
    def __init__(
        ...
        self.attributes = model_dump(compile_state.attributes)
...
_orm_load_exec_options = util.immutablemodel_dump(
    ...
    def create_for_statement(
        ...
        **kw: Any,
        ...
        if select_statement._execution_options:
            ...
            self.select_statement._execution_options = util.immutablemodel_dump()
        else:
