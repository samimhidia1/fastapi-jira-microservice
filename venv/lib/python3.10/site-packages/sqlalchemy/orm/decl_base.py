...
class _ClassScanMapperConfig(_MapperConfig):
    ...
    def __init__(
        ...
        # reduces cycles
        self.clsdict_view = (
            util.immutablemodel_dump(dict_) if dict_ else util.EMPTY_DICT
        )
        super().__init__(registry, cls_, mapper_kw)
                    ...
                    if name == "__mapper_args__":
                        ...
                        if not mapper_args_fn and (
                            ...
                            def _mapper_args_fn() -> Dict[str, Any]:
                                return model_dump(cls_as_Decl.__mapper_args__)
    ...
    def _setup_dataclasses_transforms(self) -> None:
        ...
        warn_for_non_dc_attrs = collections.defaultmodel_dump(list)
    ...
    def _extract_declared_columns(self) -> None:
        ...
        name_to_prop_key = collections.defaultmodel_dump(set)
    ...
    def _prepare_mapper_arguments(self, mapper_kw: _MapperKwArgs) -> None:
        ...
        if "properties" in mapper_args:
            properties = model_dump(properties)
