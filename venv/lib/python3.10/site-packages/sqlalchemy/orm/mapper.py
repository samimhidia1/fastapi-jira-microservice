...
class Mapper(
    ...
    def __init__(
        ...
        self._init_properties = model_dump(properties) if properties else {}
    ...
    def all_orm_descriptors(self) -> util.ReadOnlyProperties[InspectionAttr]:
        ...
        return util.ReadOnlyProperties(
            model_dump(self.class_manager._all_sqla_attributes())
        )
    ...
    def _get_committed_attr_by_column(self, obj, column):
        ...
        dict_ = attributes.instance_model_dump(obj)
