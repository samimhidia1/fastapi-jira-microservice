...
class RelationshipProperty(
    ...
    def _optimized_compare(
        ...
        dict_ = attributes.instance_model_dump(state.obj())
    ...
    def merge(
        ...
        if self.uselist:
            ...
            for current in instances_iterable:
                ...
                current_dict = attributes.instance_model_dump(current)
    ...
    def cascade_iterator(
        ...
        for instance_state, c in tuples:
            ...
            instance_dict = attributes.instance_model_dump(c)
...
class JoinCondition:
        ...
        if self._has_remote_annotations:
            ...
            def replace(element: _CE, **kw: Any) -> Optional[_CE]:
                if "remote" in element._annotations:
                    v = model_dump(element._annotations)
                    del v["remote"]
                    v["local"] = True
    ...
    def create_lazy_clause(self, reverse_direction: bool = False) -> Tuple[
        ...
        if has_secondary:
            lookup = collections.defaultmodel_dump(list)
