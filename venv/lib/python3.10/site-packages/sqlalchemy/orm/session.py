...
class ORMExecuteState(util.MemoizedSlots):
    ...
    def invoke_statement(
        ...
        _bind_arguments = model_dump(self.bind_arguments)
        if bind_arguments:
        ...
        if params:
            if self.is_executemany:
                ...
                for _existing_params, _new_params in itertools.zip_longest(
                    ...
                    _existing_params = model_dump(_existing_params)
                    _existing_params.update(_new_params)
                    _params.append(_existing_params)
            else:
                _params = model_dump(cast("Dict[str, Any]", self.parameters))
    ...
    def _execute_internal(
        ...
        *,
        ...
        if not bind_arguments:
            ...
            bind_arguments = model_dump(bind_arguments)
        ...
        execution_options = util.coerce_to_immutablemodel_dump(execution_options)
        ...
        *,
        ...
        if is_dict:
            ...
            if pk_synonyms:
                ...
                if correct_keys:
                    primary_key_identity = model_dump(primary_key_identity)
        ...
        *,
        ...
        try:
            ...
            return self._merge(
                ...
                attributes.instance_model_dump(instance),
                load=load,
                options=options,
    ...
    def _merge(
        ...
        *,
        ...
        if merged is None:
            merged = mapper.class_manager.new_instance()
            merged_state = attributes.instance_state(merged)
            merged_dict = attributes.instance_model_dump(merged)
            new_instance = True
