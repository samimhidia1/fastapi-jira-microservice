...
class LazyLoader(
    ...
    def _generate_lazy_clause(self, state, passive):
        ...
        dict_ = attributes.instance_model_dump(o)
    ...
    def _emit_lazyload(
        ...
        if pending or passive & attributes.NO_AUTOFLUSH:
            stmt._execution_options = util.immutablemodel_dump({"autoflush": False})
...
class PostLoader(AbstractRelationshipLoader):
    ...
    def _setup_for_recursion(self, context, path, loadopt, join_depth=None):
        ...
        execution_options = util.immutablemodel_dump(
...
class SubqueryLoader(PostLoader):
    ...
    class _SubqCollections:
        ...
        def _load(self):
            self._data = collections.defaultmodel_dump(list)
...
class SelectInLoader(PostLoader, util.MemoizedSlots):
    ...
    def _load_for_path(
        ...
        if query_info.load_only_child:
            our_states = collections.defaultmodel_dump(list)
            none_states = []
    ...
    def _load_via_parent(
        ...
        while our_states:
            ...
            data = collections.defaultmodel_dump(list)
