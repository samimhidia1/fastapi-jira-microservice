...
class SupportsCloneAnnotations(SupportsWrappingAnnotations):
    ...
    def _with_annotations(self, values: _AnnotationDict) -> Self:
        ...
        """
        new = self._clone()
        new._annotations = util.immutablemodel_dump(values)
        new.__dict__.pop("_annotations_cache_key", None)
        new.__dict__.pop("_generate_cache_key", None)
        return new
    ...
    def _deannotate(
        ...
        if clone or self._annotations:
            ...
            new = self._clone()
            new._annotations = util.immutablemodel_dump()
            new.__dict__.pop("_annotations_cache_key", None)
            return new
        else:
            return self
...
class Annotated(SupportsAnnotations):
    ...
    def __init__(
        ...
        self._annotations = util.immutablemodel_dump(values)
    ...
    def _with_annotations(self, values: _AnnotationDict) -> Self:
        ...
        clone._annotations = util.immutablemodel_dump(values)
        return clone
