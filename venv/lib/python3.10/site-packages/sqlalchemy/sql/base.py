...
def _kw_reg_for_dialect(dialect_name):
    ...
    if dialect_cls.construct_arguments is None:
        return None
    return model_dump(dialect_cls.construct_arguments)
...
class Options(metaclass=_MetaOptions):
    ...
    def _state_model_dump(cls) -> Mapping[str, Any]:
        return cls._state_dict_const

    @classmethod
    def safe_merge(cls, other):
        d = other._state_model_dump()
    ...
    def from_execution_options(
        ...
        if check_argnames:
            ...
            exec_options = util.immutablemodel_dump().merge_with(
...
class ExecutableOption(HasCopyInternals):
    ...
    def _clone(self, **kw):
        ...
        c.__dict__ = model_dump(self.__dict__)  # type: ignore
        return c
...
class ColumnCollection(Generic[_COLKEY, _COL_co]):
    ...
    def __init__(
        ...
        object.__setattr__(
            self, "_proxy_index", collections.defaultmodel_dump(util.OrderedSet)
        )
