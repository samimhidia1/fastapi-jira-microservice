...
class Compiled:
    ...
    def __init__(
        ...
        compile_kwargs: Mapping[str, Any] = util.immutablemodel_dump(),
    ):
...
class SQLCompiler(Compiled):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # a dictionary of BindParameter instances to "compiled" names
        # that are actually present in the generated SQL
        self.bind_names = util.column_model_dump()
    ...
    def construct_params(
        ...
        if self._render_postcompile and not _no_postcompile:
            ...
            if not params:
                return model_dump(self._post_compile_expanded_state.parameters)
            else:
                raise exc.InvalidRequestError(
    ...
    def visit_compound_select(
        ...
        text += self.group_by_clause(cs, **model_dump(asfrom=asfrom, **kwargs))
    ...
    if not typing.TYPE_CHECKING:
        _default_stack_entry = util.immutablemodel_dump(
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    ...
    _sentinel_col_non_autoinc_lookup = util.immutablemodel_dump(
        {
