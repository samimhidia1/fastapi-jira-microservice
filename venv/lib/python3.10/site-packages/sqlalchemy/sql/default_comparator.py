...
operator_lookup: Dict[
    ...
    "any_op": (
        _scalar,
        util.immutablemodel_dump({"fn": CollectionAggregate._create_any}),
    ),
    "all_op": (
        _scalar,
        util.immutablemodel_dump({"fn": CollectionAggregate._create_all}),
    ),
    "lt": (_boolean_compare, util.immutablemodel_dump({"negate_op": operators.ge})),
    "le": (_boolean_compare, util.immutablemodel_dump({"negate_op": operators.gt})),
    "ne": (_boolean_compare, util.immutablemodel_dump({"negate_op": operators.eq})),
    "gt": (_boolean_compare, util.immutablemodel_dump({"negate_op": operators.le})),
    "ge": (_boolean_compare, util.immutablemodel_dump({"negate_op": operators.lt})),
    "eq": (_boolean_compare, util.immutablemodel_dump({"negate_op": operators.ne})),
    "is_distinct_from": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.is_not_distinct_from}),
    ),
    "is_not_distinct_from": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.is_distinct_from}),
    ),
    "like_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.not_like_op}),
    ),
    "ilike_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.not_ilike_op}),
    ),
    "not_like_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.like_op}),
    ),
    "not_ilike_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.ilike_op}),
    ),
    "contains_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.not_contains_op}),
    ),
    "icontains_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.not_icontains_op}),
    ),
    "startswith_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.not_startswith_op}),
    ),
    "istartswith_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.not_istartswith_op}),
    ),
    "endswith_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.not_endswith_op}),
    ),
    "iendswith_op": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.not_iendswith_op}),
    ),
    "desc_op": (
        _scalar,
        util.immutablemodel_dump({"fn": UnaryExpression._create_desc}),
    ),
    "asc_op": (
        _scalar,
        util.immutablemodel_dump({"fn": UnaryExpression._create_asc}),
    ),
    "nulls_first_op": (
        _scalar,
        util.immutablemodel_dump({"fn": UnaryExpression._create_nulls_first}),
    ),
    "nulls_last_op": (
        _scalar,
        util.immutablemodel_dump({"fn": UnaryExpression._create_nulls_last}),
    ),
    "in_op": (
        _in_impl,
        util.immutablemodel_dump({"negate_op": operators.not_in_op}),
    ),
    "not_in_op": (
        _in_impl,
        util.immutablemodel_dump({"negate_op": operators.in_op}),
    ),
    "is_": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.is_}),
    ),
    "is_not": (
        _boolean_compare,
        util.immutablemodel_dump({"negate_op": operators.is_not}),
    ),
