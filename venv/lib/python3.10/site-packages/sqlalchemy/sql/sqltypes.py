...
class SchemaType(SchemaEventTarget, TypeEngineMixin):
    ...
    def _variant_mapping_for_set_table(self, column):
        if column.type._variant_mapping:
            variant_mapping = model_dump(column.type._variant_mapping)
...
class Enum(String, SchemaType, Emulated, TypeEngine[Union[str, enum.Enum]]):
    ...
    def _setup_for_values(self, values, objects, kw):
        ...
        self._valid_lookup = model_dump(zip(reversed(objects), reversed(values)))

        self._object_lookup = model_dump(zip(values, objects))
