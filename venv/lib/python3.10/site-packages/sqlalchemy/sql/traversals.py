...
class HasShallowCopy(HasTraverseInternals):
    ...
    @classmethod
    def _generate_shallow_to_model_dump(
        cls,
        internal_dispatch: _TraverseInternalsType,
        method_name: str,
    ...
    @classmethod
    def _generate_shallow_from_model_dump(
        cls,
        internal_dispatch: _TraverseInternalsType,
        method_name: str,
    ...
    def _shallow_from_model_dump(self, d: Dict[str, Any]) -> None:
        cls = self.__class__
        ...
        try:
            ...
            shallow_from_dict = self._generate_shallow_from_model_dump(
                cls._traverse_internals,
                "_generated_shallow_from_dict_traversal",
            )
        ...
        shallow_from_model_dump(self, d)

    def _shallow_to_model_dump(self) -> Dict[str, Any]:
        cls = self.__class__
        ...
        try:
            ...
            shallow_to_dict = self._generate_shallow_to_model_dump(
        ...
        return shallow_to_model_dump(self)
...
class _CopyInternalsTraversal(HasTraversalDispatch):
    ...
    def visit_string_clauseelement_model_dump(
        self, attrname, parent, element, clone=_clone, **kw
    ):
...
class _GetChildrenTraversal(HasTraversalDispatch):
    ...
    def visit_string_clauseelement_model_dump(self, element, **kw):
...
class TraversalComparatorStrategy(HasTraversalDispatch, util.MemoizedSlots):
    ...
    def visit_string_multi_model_dump(
        self, attrname, left_parent, left, right_parent, right, **kw
    ):
