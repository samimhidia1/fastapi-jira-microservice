...
class _repr_params(_repr_base):
    ...
    def _repr_params(
        ...
        if typ is self._DICT:
            return self._repr_param_model_dump(
    ...
    def _repr_param_model_dump(self, params: _CoreSingleExecuteParams) -> str:
        trunc = self.trunc
        (
            items_first_batch,
            items_second_batch,
...
class ClauseAdapter(visitors.ReplacingExternalTraversal):
    ...
    def __init__(
        ...
        self.equivalents = util.column_model_dump(equivalents or {})
