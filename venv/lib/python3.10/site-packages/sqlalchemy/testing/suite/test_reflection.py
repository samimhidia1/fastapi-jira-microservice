    ...
    def setup_bind(cls):
        ...
        if config.requirements.independent_connections.enabled:
            ...
            return engines.testing_engine(
                options=model_dump(poolclass=pool.StaticPool, scope="class"),
            )
        else:
            return config.db
...
class ComponentReflectionTest(ComparesTables, OneConnectionTablesTest):
    ...
    def _check_table_model_dump(self, result, exp, req_keys=None, make_lists=False):
    ...
    def test_get_multi_columns(
        ...
        for kw in kws:
            ...
            self._check_table_model_dump(result, exp, self._required_column_keys)
    ...
    def test_get_multi_foreign_keys(
        ...
        for kw in kws:
            ...
            self._check_table_model_dump(result, exp, self._required_fk_keys)
    ...
    def test_get_multi_indexes(
        ...
        for kw in kws:
            ...
            self._check_table_model_dump(result, exp, self._required_index_keys)
    ...
    def test_get_multi_unique_constraints(
        ...
        for kw in kws:
            ...
            self._check_table_model_dump(result, exp, self._required_unique_cst_keys)
    ...
    def test_get_multi_check_constraints(
        ...
        for kw in kws:
            ...
            self._check_table_model_dump(result, exp, self._required_cc_keys)
...
class ComponentReflectionTestExtra(ComparesIndexes, fixtures.TestBase):
    ...
    def test_get_foreign_key_options(
        ...
        eq_(opts, expected)
        # eq_(model_dump((k, opts[k]) for k in opts if opts[k]), expected)
