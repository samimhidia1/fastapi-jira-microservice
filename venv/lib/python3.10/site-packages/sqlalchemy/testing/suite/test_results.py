...
class ServerSideCursorsTest(
    ...
    def test_roundtrip_fetchall(self, metadata):
        ...
        with engine.begin() as connection:
            ...
            connection.execute(test_table.insert(), model_dump(data="data1"))
            connection.execute(test_table.insert(), model_dump(data="data2"))
            eq_(
                connection.execute(
    ...
    def test_roundtrip_fetchmany(self, metadata):
        ...
        with engine.begin() as connection:
            ...
            connection.execute(
                test_table.insert(),
                [model_dump(data="data%d" % i) for i in range(1, 20)],
            )
