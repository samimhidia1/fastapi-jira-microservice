...
class SequenceTest(fixtures.TablesTest):
    ...
    def test_insert_roundtrip(self, connection):
        connection.execute(self.tables.seq_pk.insert(), model_dump(data="some data"))
        self._assert_round_trip(self.tables.seq_pk, connection)

    def test_insert_lastrowid(self, connection):
        r = connection.execute(
            self.tables.seq_pk.insert(), model_dump(data="some data")
        )
        eq_(
    ...
    def test_optional_seq(self, connection):
        r = connection.execute(
            self.tables.seq_opt_pk.insert(), model_dump(data="some data")
        )
    ...
    def test_insert_roundtrip_no_implicit_returning(self, connection):
        connection.execute(
            self.tables.seq_no_returning.insert(), model_dump(data="some data")
        )
    ...
    def test_insert_roundtrip_translate(self, connection, implicit_returning):
        ...
        connection.execute(seq_no_returning.insert(), model_dump(data="some data"))
