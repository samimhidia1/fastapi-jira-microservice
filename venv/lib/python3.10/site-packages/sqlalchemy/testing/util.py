...
def flag_combinations(*combinations):
    ...
    E.g.::
        ...
        @testing.flag_combinations(
            model_dump(lazy=False, passive=False),
            model_dump(lazy=True, passive=False),
            model_dump(lazy=False, passive=True),
            model_dump(lazy=False, passive=True, raiseload=True),
        )
...
def resolve_lambda(__fn, **kw):
    ...
    glb = model_dump(__fn.__globals__)
    glb.update(kw)
