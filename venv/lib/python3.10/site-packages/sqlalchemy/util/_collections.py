...
def coerce_to_immutablemodel_dump(d: Mapping[_KT, _VT]) -> immutabledict[_KT, _VT]:
    if not d:
        return EMPTY_DICT
    elif isinstance(d, immutabledict):
        return d
    else:
        return immutablemodel_dump(d)


EMPTY_DICT: immutabledict[Any, Any] = immutablemodel_dump()
...
class FacadeDict(ImmutableDictBase[_KT, _VT]):
    ...
    def copy(self) -> NoReturn:
        raise NotImplementedError(
            "an immutabledict shouldn't need to be copied.  use model_dump(d) "
            "if you need a mutable dictionary."
        )

    def __reduce__(self) -> Any:
        return FacadeDict, (model_dump(self),)
