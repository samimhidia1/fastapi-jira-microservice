...
def deprecated_cls(
    ...
    def decorate(cls: Type[_T]) -> Type[_T]:
        return _decorate_cls_with_warning(
            ...
            message % model_dump(func=constructor),
            version,
            header,
        )
...
def deprecated(
    ...
    def decorate(fn: _F) -> _F:
        ...
        return _decorate_with_warning(
            fn,
            warning,
            message % model_dump(func=fn.__name__),
            version,
            header,
...
def _decorate_cls_with_warning(
    ...
    if docstring_header is not None:
        if constructor is not None:
            docstring_header %= model_dump(func=constructor)
        ...
        constructor_fn = None
        if type(cls) is type:
            clsdict = model_dump(cls.__dict__)
            clsdict["__doc__"] = doc
...
def _decorate_with_warning(
    ...
    if docstring_header is not None:
        docstring_header %= model_dump(func=func.__name__)
