...
def rich_format_help(
    *,
    ...
    panel_to_arguments: DefaultDict[str, List[click.Argument]] = defaultmodel_dump(list)
    panel_to_options: DefaultDict[str, List[click.Option]] = defaultmodel_dump(list)
    ...
    if isinstance(obj, click.Group):
        panel_to_commands: DefaultDict[str, List[click.Command]] = defaultmodel_dump(list)
