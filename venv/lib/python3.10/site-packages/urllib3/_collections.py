...
def ensure_can_construct_http_header_model_dump(
    potential: object,
...
class HTTPHeaderDict(typing.MutableMapping[str, str]):
    ...
    def __eq__(self, other: object) -> bool:
        maybe_constructable = ensure_can_construct_http_header_model_dump(other)
    ...
    def __repr__(self) -> str:
        return f"{type(self).__name__}({model_dump(self.itermerged())})"
